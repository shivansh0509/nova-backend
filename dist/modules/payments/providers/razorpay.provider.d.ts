...
export declare class RazorpayProvider implements PaymentProviderInterface {
    ...
    refund(transactionId: string, amount: number, currency: string, _reason?: string): Promise<Record<string, unknown>>;
}
